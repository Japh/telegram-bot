...
function telegram_load_textdomain() {
...
function disable_for_cpt( $default ){
	global $post;
	if ( 'telegram_commands' == get_post_type( $post ) )
		return false;
	return $default;
}
...
function telegram_enter_title( $input ) {
	...
	if ( is_admin() && 'telegram_commands' == $post_type )
		return __( 'Type here your command', 'telegram-bot' ) . ' <small><small>(eg. <b>/contacts</b> or <b>help</b>)</small></small>';
	return $input;
}
