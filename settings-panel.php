        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <select name="wp_telegram[mode]">
                        <option <?php if ( ! is_ssl() ) { echo 'disabled'; } ?> value="0" <?php if ( isset( $options['mode'] ) && $options['mode'] == 0 ) { echo ' selected="selected"'; } ?>>Telegram WebHooks</option>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <br> <small>enable zapier integration &bull; Beta &bull; <a href="https://zapier.com/developer/invite/26805/1ec54299d4307c0b86b7417d0866ff25/">Click here to get an invite</a></small>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                ...
                <td>
                    <input id="channelusername" type="text" name="wp_telegram[channelusername]" value="<?php echo ( ! empty( $options['channelusername'] ) ? $options['channelusername'] : '' ); ?>" size="55" />
                    <br><small>Insert here your channel username if you want to stream messages to it. Ex. <b>@sanpellegrinoterme</b>
                        <br>The bot must be administrator in your channel</small>
                </td>
            </tr>
            <tr valign="top" <?php if ( empty( $options['debug'] ) ) { echo 'style="display:none;"'; } ?>>
                ...
                <td>
                    ...
                    <br> <small>Enable debugging. Do not use this if not asked by support!</small>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <br><small>This will be shown when the command doesn't exist.</small>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <br><small>Example: <b>1,2,3;4,5,6;Text</b></small>
                </td>
            </tr>
        </table>
        <p class="submit">
