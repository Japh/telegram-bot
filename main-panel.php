...
<?php endif; ?>        </div>
    ...
    <div id="welcome-panel" class="welcome-panel" style="padding-bottom: 20px;">
            ...
            <h4>Stats</h4>
            <ul>
                <li><a href="admin.php?page=telegram_log" class="welcome-icon dashicons-email"><?php echo get_option( 'wp_telegram_dispatches' ); ?> messages dispatched</a></li>
                <li><a href="edit.php?post_type=telegram_subscribers" class="welcome-icon dashicons-admin-users"><?php echo wp_count_posts( 'telegram_subscribers' )->publish; ?> people subscribed</a></li>
                <li><a href="edit.php?post_type=telegram_subscribers" class="welcome-icon dashicons-groups"><?php echo wp_count_posts( 'telegram_groups' )->publish; ?> groups subscribed</a></li>
                <li><a href="edit.php?post_type=telegram_commands" class="welcome-icon dashicons-admin-settings"><?php echo wp_count_posts( 'telegram_commands' )->publish; ?> commands</a></li>
            </ul>
        </div>
